...
Vagrant.configure("2") do |config|
  ...
  (1..5).each do |i|
	...
	vb.gui= false
      ...
      node.vm.network "forwarded_port", guest: 53, host: 1053 + i
  ...
  config.vm.define "machine5" do |machine5|
    machine5.vm.network "private_network", ip: "192.168.56.12"
  end
  ...
  config.vm.define "machine3" do |machine3|
    machine3.vm.network "private_network", ip: "192.168.56.10"
  end
  config.vm.define "machine4" do |machine4|
    machine4.vm.network "private_network", ip: "192.168.56.11"
  end
  config.vm.box= "machine3"
